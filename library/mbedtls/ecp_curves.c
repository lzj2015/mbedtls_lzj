...
};//A9FB57DB A1EEA9BC 3E660A909D838D72 6E3BF623D52620282013481D1F6E5377
...
// static int ecp_mod_p256v1(mbedtls_mpi *);
...
/**
 * Fast quasi-reduction modulo 256v1 = 2^256 - R,
 * with R =2^256 - 2^168 - 2^96 + 2^64 -1
 *
 * 00000001 00000000 00000000 00000000 00000000 FFFFFFFF 00000000 00000001
 *
 */
// #if defined(ECP_DP_SM2_256V1_ENABLED)

// static int ecp_mod_p256v1(mbedtls_mpi *N) {
// #if defined(SM2_TEST)
//     //7ABD2961 B3FBB0E7 1746DBDA 40900821 BA8D7C6E A3BAAE82 8DD12474 F70E203D
//     static mbedtls_mpi_uint Rp[] = {
//             BYTES_TO_T_UINT_8(0x01, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x01)};
// #else
//     static mbedtls_mpi_uint Rp[] = {
//             BYTES_TO_T_UINT_8(0x01, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x01)};
// #endif
...
// #endif /*ECP_DP_SM2_256V1_ENABLED*/

...
#include <SSL/mbedtls/config.h>
#else
#include MBEDTLS_CONFIG_FILE
#endif

#include <SSL/mbedtls/asn1.h>
...
// GB/T 33560-2017 OID Defination
#define MBEDTLS_OID_ORG_CSTC                    "\xcf\x55"      /* {cstc(10197)} */
#define MBEDTLS_OID_CSTC                MBEDTLS_OID_ISO_MEMBER_BODIES MBEDTLS_OID_COUNTRY_CN \
                                        MBEDTLS_OID_ORG_CSTC
                                        /* {iso(1) member-body(2) cn(156) cstc(10197)} */
...
/*
 * CSTC definition OIDs
 */
#define MBEDTLS_OID_GM                  MBEDTLS_OID_CSTC "\x01" /**< gm OBJECT IDENTIFIER ::= { iso(1) member-body(2) cn(156) cstc(10197) 1 } */
#define MBEDTLS_OID_GM_SM2              MBEDTLS_OID_GM "\x82\x2d" /**< sm2 OBJECT IDENTIFIER ::= { iso(1) member-body(2) cn(156) cstc(10197) gm(1) sm2(301) } */
#define MBEDTLS_OID_GM_SM3              MBEDTLS_OID_GM "\x83\x11" /**< sm3 OBJECT IDENTIFIER ::= { iso(1) member-body(2) cn(156) cstc(10197) gm(1) sm3(401) } */
#define MBEDTLS_OID_GM_SM4              MBEDTLS_OID_GM "\x68" /**< sm4 OBJECT IDENTIFIER ::= { iso(1) member-body(2) cn(156) cstc(10197) gm(1) sm4(104) } */
...
#define MBEDTLS_OID_DIGEST_ALG_SM3              MBEDTLS_OID_GM_SM3             
